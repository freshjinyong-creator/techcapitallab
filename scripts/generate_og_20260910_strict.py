...
def main():
    ...
    d.text((lx, 150 * scale), "KOSPI 7,000pt 공방 & 배터리 반사수혜", fill=(255, 255, 255),
    ...
    d.text((lx, 285 * scale), "네 마녀의 날 수급 / LG엔솔 +6.5% / 메타 +6.55% AI 모멘텀", fill=(226, 232, 240),
           font=ImageFont.truetype(FONT_SEMI, 20 * scale))

    cy, ch = 380 * scale, 170 * scale
    cards = [
        ("KOSPI / KOSDAQ", "7,000pt 공방", "코스닥 +0.79% (836.92pt)", (56, 189, 248)),
        ("2차전지 반사수혜", "LGES +6.5%", "미-중 배터리 파트너십 규제", (16, 185, 129)),
        ("글로벌 AI 특징주", "META +6.55%", "AI 에이전트 Muse 공개", (245, 158, 11)),
    ]
