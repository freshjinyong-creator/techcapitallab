...
```
      ...
      ┌────────────────────────────────────────────────────────┐
      │  1. 미국 금리 (글로벌 자본의 유동성 기준점)              │
      │     ➔ 전 세계 자산의 할인율과 달러 향방을 결정하는 축    │
      ├────────────────────────────────────────────────────────┤
      │  2. 일본 엔화 (저금리 레버리지 자금원)                     │
      │     ➔ 캐리 트레이드를 통해 글로벌 자산에 유동성 공급      │
      ├────────────────────────────────────────────────────────┤
      │  3. 중국 제조업 (세계 최대 공급망 및 주요 수요처)          │
      │     ➔ 원자재를 흡수하고 중간재/완제품 교역을 주도하는 축  │
      └────────────────────────────────────────────────────────┘
```
...
1. 초저금리를 유지하던 일본 금융시장에서 엔화를 대출받습니다.
2. 대출받은 엔화를 달러나 신흥국 통화로 환전합니다.
3. 금리가 높은 미국 국채나 글로벌 고수익 자산(테크주, 반도체 등)을 매수합니다.
4. 금리 차이(스프레드)와 자산 가격 상승에 따른 레버리지 수익을 추구합니다.
```
