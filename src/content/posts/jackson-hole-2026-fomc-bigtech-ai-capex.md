...
* <strong>감가상각비의 급격한 증</strong>가: 지난 2에서 3년간 공격적으로 집행된 하드웨어 투자가 감가상각 연한(통상 4에서 6년)에 진입하면서 영업이익률(Operating Margin)에 구조적 부담을 주기 시작했습니다.
* <strong>소프트웨어 및 B2B 전환 속도 둔화</strong>: 인프라 구축 속도에 비해 엔터프라이즈 기업들의 실제 AI 워크로드 도입 및 유료 구독 전환율 상승 속도가 시장 기대치를 밑돌고 있습니다.
* <strong>잉여현금흐름(FCF) 둔화</strong>: 대규모 CAPEX 집행으로 인해 매출은 성장하지만 기업의 실질 현금 창출 능력을 나타내는 FCF 마진이 정체되거나 일부 축소되는 현상이 관측됩니다.
...
* <strong>실질 잉여현금흐름(FCF) 중심 선별</strong>: AI 투자 사이클 속에서도 안정적인 FCF를 창출하고 자사주 매입 및 소각 등 주주환원 여력이 충분한 기업에 집중해야 합니다.
* <strong>AI 수익화 가시성 평</strong>가: 하드웨어 공급망 중심에서 벗어나, 기업용 소프트웨어(SaaS)에 AI를 성공적으로 결합하여 실제 가입자당 평균 매출(ARPU)을 끌어올리는 소프트웨어 강자를 선별해야 합니다.
* <strong>분할 매수 및 포트폴리오 균형</strong>: 9월 FOMC 점도표(Dot Plot) 발표와 3분기 빅테크 실적 발표 전까지는 현금 비중을 일정 부분 유지하며, 변동성 확대를 저가 분할 매수의 기회로 활용하는 전략이 유효합니다.
