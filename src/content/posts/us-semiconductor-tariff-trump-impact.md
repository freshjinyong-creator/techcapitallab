...
산업 전문가들과 글로벌 반도체 업계는 이번 완제품 관세 카드를 두고 **단기적 자승자박(Self-defeating), 장기적 위협(Threat)**이라는 상반된 두 가지 시각을 동시에 제기합니다.

```
[트럼프 반도체 관세 파장의 이중 구조]
...
┌───────────────────────────┐ ┌───────────────────────────┐
│     단기적 자승자박       │ │       장기적 위협         │
│  (미국 자체의 부메랑)     │ │   (한국 산업의 공동화)    │
├───────────────────────────┤ ├───────────────────────────┤
│• HBM·파운드리 대체 불가   │ │• 한국 자본의 대미 강제이전│
│• 빅테크 AI 구축비용 폭증  │ │• 국내 반도체 생태계 위축  │
│• IT 기기값 인상 및 인플레 │ │• 글로벌 효율 분업망 파괴  │
└───────────────────────────┘ └───────────────────────────┘
```
